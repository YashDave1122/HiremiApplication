...
from .models import City, CorporateDiscount, CorporateTraining, Discount, EmailOTP, LiveProjectHub, LiveProjectHubApplication,  Mentorship, MentorshipDiscount, PasswordResetOTP, State, TrainingProgram, TrainingProgramApplication
...
class DiscountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Discount
        fields = '__all__'
        extra_fields = ['discounted_price']  # Add discounted_price explicitly

    def get_discounted_price(self, obj):
        return obj.discounted_price  # Calls the property on the model
...
class LiveProjectHubSerializer(serializers.ModelSerializer):
    
    discounted_price = serializers.ReadOnlyField()

    class Meta:
        model = LiveProjectHub
        fields = '__all__' 



class LiveProjectHubApplicationSerializer(serializers.ModelSerializer):
    class Meta:
        model = LiveProjectHubApplication
        fields ='__all__' 
