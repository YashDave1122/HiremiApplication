...
import 'package:pre_dashboard/Internship/DetailedInternship.dart';
                ...
                onPressed: () async {
                  ...
                  // else {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (ctx) => DetailedInternship(
                          id: id,
                          profile: profile,
                          exp: exp.toString(),
                          mode: mode,
                          ...
                          termsAndConditions: '',
                          ctc: double.parse(ctc), // Convert to appropriate type if needed
