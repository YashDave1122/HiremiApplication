...
import 'package:pre_dashboard/Hiremi360/screens/live_peoject_hub.dart';
...
class _HomeScreen360State extends State<HomeScreen360> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: const CustomDrawer(isVerified: true,),
      body: SafeArea(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        CustomHiremiFeatured(
                          ...
                          imageHeight: size.height * 0.133,
                          imageWidth: size.width * 0.3,
                          logoHeight: size.height * 0.025,
                          logoWidth: size.height * 0.035,
                          showLogo: true,
                          onTap: () {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        CustomHiremiFeatured(
                          image: 'assets/images/Live Project Hub.png',
                          logo: '',
                          title: '',
                          imageHeight: size.height * 0.133,
                          imageWidth: size.width * 0.3,
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => LiveProjectHubPage()));
                          },
                        ),
                        CustomHiremiFeatured(
                          image: 'assets/images/training_internship1.png',
