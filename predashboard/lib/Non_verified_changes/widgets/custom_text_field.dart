...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  void initState() {
    super.initState();
    _selectedValue = widget.value ?? widget.controller.text;
    widget.controller.addListener(_updateSelectedValue);
  }
  ...
  @override
  void dispose() {
    widget.controller.removeListener(_updateSelectedValue);
    super.dispose();
  }
        ...
        SizedBox(
          ...
          child: widget.isDropdown
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: widget.readOnly
                  ? const Icon(Icons.edit_outlined, color: Color(0xFF0F3CC9))
                  : null,
            ),
          ),
        ),
