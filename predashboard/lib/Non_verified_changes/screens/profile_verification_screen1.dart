                ...
                SizedBox(
                  ...
                  child: CustomCircularProgress(
                    progress: verificationStep == 0 || verificationStep == 1
                        ...
                        : (verificationStep == 3
                        ? 65
                        : (verificationStep == 4 ? 85 : 99))),
                  ),
                ),
                // SizedBox(height: screenHeight * 0.01),
                const HorizontalLine(),
                SizedBox(
                  height: screenHeight * 0.6, // Provide a height constraint
                  child: verificationStep == 0
                      ...
                      : (verificationStep == 4
                      ? CustomFormWidget5(onProceed: _onFormComplete)
                      : CustomFormWidget6(onSubmit: _onFormComplete))))),
                ),
              ],
            ),
          ),
